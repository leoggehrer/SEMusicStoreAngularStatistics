//@CodeCopy
using SEMusicStoreAngularStatistics.Common.Modules.Exceptions;
using SEMusicStoreAngularStatistics.Logic.Contracts;
using System.Reflection;

namespace SEMusicStoreAngularStatistics.Logic.DataContext
{
    /// <summary>
    /// Represents the database context for the SEMusicStoreAngularStatistics application.
    /// </summary>
    internal sealed partial class ProjectDbContext : DbContext, IContext
    {
        ...
        /// </summary>
        private static readonly string ConnectionString = "data source=SEMusicStoreAngularStatistics.db";
        #endregion fields
