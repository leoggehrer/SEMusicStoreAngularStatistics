//@CodeCopy
#if ACCOUNT_ON
using SEMusicStoreAngularStatistics.Logic.Entities.Account;
using SEMusicStoreAngularStatistics.Logic.Modules.Exceptions;
using SEMusicStoreAngularStatistics.Logic.Modules.Security;
using System.Text;
using System.Text.RegularExpressions;

namespace SEMusicStoreAngularStatistics.Logic.Modules.Account
{
    using PasswordRules = CommonModules.Security.PasswordRules;
    using Error = CommonModules.Exceptions.ErrorType;
    using System.Reflection;
    using SEMusicStoreAngularStatistics.Common.Modules.ThreadSafe;
